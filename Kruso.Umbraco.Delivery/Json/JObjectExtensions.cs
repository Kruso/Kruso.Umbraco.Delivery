...
//    {
//        public static string[] AllPropNames(this JObject node)
//        {
//            return node?.Properties()?.Select(p => p.Name).ToArray() ?? new string[0];
//        }

//        public static IEnumerable<JObject> Blocks(this JObject node)
//        {
//            if (node != null)
//            {
//                foreach (var propName in node.AllPropNames())
//                {
//                    var dataNode = node[propName].Value<JObject>();
//                    if (dataNode.IsBlock())
//                    {
...
//        public static bool IsBlock(this JObject node)
//        {
//            return node != null
//                && node.Id != Guid.Empty
